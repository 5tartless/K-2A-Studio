...
class ImportProjectMenu(K2A_Menu):
    ...
    def init_fill_request(self):
        ...
        # Quitar los bordes de las tarjetas para evitar las lineas blancas
        self.get_widget("/center/options/repo").setStyleSheet("border: none;")
        self.get_widget("/center/options/local").setStyleSheet("border: none;")
